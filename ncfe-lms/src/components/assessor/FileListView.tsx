...
export default function FileListView({ items, onItemClick, onRename, onDelete, onPreview, onDownload }: FileListViewProps) {
  ...
  const hasActions = onRename || onDelete || onPreview || onDownload;
